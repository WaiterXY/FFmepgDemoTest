...
Java_com_example_ffmpegdemotest_MainActivity_avcodecinfo(JNIEnv *env, jobject instance) {
...
extern "C"
jstring
Java_com_example_ffmpegdemotest_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
//extern "C"
//JNIEXPORT jstring JNICALL
//Java_com_example_ffmpegdemotest_MainActivity_stringFromJNI(JNIEnv *env, jobject instance) {
//
//    // TODO
//
//
